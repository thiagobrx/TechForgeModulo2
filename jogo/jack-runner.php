<div class="container-sm">
    ...
    <div class="flex-game">
        ...
        <div class="flex-game-descricao">
            <p>
            Jack Runner é um jogo de corrida infinita, onde a cada obstaculo que o personagem principal desviar,  ganha uma pontução no seu score. 
            O objetivo do jogo é conseguir ultrapassar o seu proprio limite e conseguir chegar numa pontução mais alta que você conseguir!
            </p>
        </div>
    </div>
    ...
    <h2>Jogue Agora</h2>
    <iframe src="jogo/Projeto Kelwin/Jogo/index.html" width="1280" height="768" frameborder="0"></iframe>
</div>